...
| `hl=` | Arayüz | 🔗 URL PARAMETRESİ | Google arayüz dilini seçer; sonuç dilini tek başına kesin olarak sınırlamaz. | `hl=tr` | [B1](kaynaklar.md#b1), [G4](kaynaklar.md#g4) | 2026-08-25 |
| `gl=` | Ülke bağlamı | 🔗 URL PARAMETRESİ | Aramanın ülke/market bağlamını etkiler. | `gl=tr` | [B1](kaynaklar.md#b1) | 2026-08-25 |
| `lr=` | İçerik dili | 🔗 URL PARAMETRESİ | Sonuçları belirtilen içerik dili veya dilleriyle sınırlar. | `lr=lang_tr` | [B1](kaynaklar.md#b1), [G4](kaynaklar.md#g4) | 2026-08-25 |
| `cr=` | Ülke kısıtı | 🔗 URL PARAMETRESİ | Sonuçları ülke bağlamına göre kısıtlar; `gl` ile aynı işlev değildir. | `cr=countryTR` | [B1](kaynaklar.md#b1), [G4](kaynaklar.md#g4) | 2026-08-25 |
...
| Parametre | Kategori | Durum | Türkçe açıklama | Güvenli örnek | Kaynak | Son doğrulama |
|---|---|---|---|---|---|---|
| `as_q=` | Gelişmiş sorgu | 🔗 URL PARAMETRESİ | Tüm kelimeler alanı. | `as_q=open+source` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_epq=` | Gelişmiş sorgu | 🔗 URL PARAMETRESİ | Tam ifade alanı. | `as_epq=annual+report` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_oq=` | Gelişmiş sorgu | 🔗 URL PARAMETRESİ | Kelimelerden herhangi biri alanı. | `as_oq=python+rust` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_eq=` | Gelişmiş sorgu | 🔗 URL PARAMETRESİ | Hariç tutulacak kelimeler alanı. | `as_eq=draft` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_nlo=` / `as_nhi=` | Sayısal aralık | 🔗 URL PARAMETRESİ | Alt ve üst sayısal sınır alanları. | `as_nlo=100&as_nhi=500` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_sitesearch=` | Site/domain | 🔗 URL PARAMETRESİ | Gelişmiş aramadaki site veya domain alanı. | `as_sitesearch=example.com` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_filetype=` | Dosya türü | 🔗 URL PARAMETRESİ | Gelişmiş aramadaki dosya türü alanı. | `as_filetype=pdf` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_occt=` | Terimin konumu | 🔗 URL PARAMETRESİ | Terimin sayfa, başlık, metin, URL veya bağlantı konumunu seçen alan. | `as_occt=title` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_qdr=` | Son güncelleme | 🔗 URL PARAMETRESİ | Advanced Search formundaki göreli zaman alanı. | `as_qdr=w` | [G4](kaynaklar.md#g4) | 2026-08-25 |
| `as_rights=` | Kullanım hakları | 🔗 URL PARAMETRESİ | Lisans/kullanım hakları filtresini taşır. Sonucun gerçek lisansını kaynak sitede ayrıca doğrulayın. | `as_rights=<form-değeri>` | [G4](kaynaklar.md#g4) | 2026-08-25 |
